...
class cmSelectExpanded extends BaseComponent {
    template = `
    ...
    static getTag = () => 'cm-select-expanded';
    static getType = () => 'cmSelectExpanded';
    ...
    update = function () {
        ...
        this.switchButton(BUTTON_CLEAR, sum === 0 && sumNew === 0);
    ...
    listUpdate = function () {
        ...
        this.$objects.decButtons.forEach((el) => el.addEventListener('click', this.dec));
        this.$objects.incButtons.forEach((el) => el.addEventListener('click', this.inc));
    ...
    render(app, node) {
        ...
        this.$el.querySelector('div[data-dropdown]').addEventListener('click', this.focus);
